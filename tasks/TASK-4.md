...
PR `develop → main`, reviewer `vladefr97`, сообщение в чат: «project-autocomplete, ник, этап 4, PR готов». Подробно — в [README](../README.md#как-сдавать), раздел «Как сдавать».
