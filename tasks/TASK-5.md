...
PR `develop → main`, reviewer `vladefr97`, скриншот сообщения бота — в описании PR. Сообщение в чат: «project-autocomplete, ник, этап 5, PR готов». Подробно — в [README](../README.md#как-сдавать), раздел «Как сдавать».
